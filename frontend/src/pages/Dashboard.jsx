...
export default function Dashboard() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6 bg-gray-900 min-h-screen text-gray-100">
      <h1 className="text-3xl md:text-4xl font-extrabold mb-6 text-center text-white">Dashboard</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {user && (
              <div className="bg-gray-800 p-6 rounded-2xl shadow-xl border border-gray-700 hover:shadow-2xl transition transform hover:scale-[1.02]">
                <h2 className="font-semibold text-2xl mb-4 text-white border-b border-gray-700 pb-2">User Info</h2>
                <div className="mt-4 space-y-3">
                  {["id", "email", "display_name", "role"].map((field) => (
                    <div key={field}>
                      <p className="text-gray-400 font-medium">{field.replace("_", " ").toUpperCase()}</p>
                ...
                <button
                  ...
                  className="mt-6 w-full bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-xl hover:from-red-600 hover:to-pink-600 transition"
                >
                  Logout
                </button>
              </div>
  ...
  <div className="bg-gray-800 p-6 rounded-2xl shadow-xl border border-gray-700 hover:shadow-2xl transition transform hover:scale-[1.02]">
    ...
    <div className="flex flex-col gap-6 mt-4">
      <div className="bg-gradient-to-r from-green-700 to-green-500 p-6 rounded-xl text-center shadow-md hover:shadow-lg transition transform hover:scale-[1.02]">
      ...
      <div className="bg-gradient-to-r from-blue-700 to-blue-500 p-6 rounded-xl text-center shadow-md hover:shadow-lg transition transform hover:scale-[1.02]">
      ...
      <div className="bg-gradient-to-r from-red-700 to-red-500 p-6 rounded-xl text-center shadow-md hover:shadow-lg transition transform hover:scale-[1.02]">
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-4">
                  {badges.map((badge) => (
                    <div
                      key={badge.key}
                      className="bg-gray-800 shadow-xl rounded-2xl w-40 p-4 flex flex-col items-center text-center hover:shadow-2xl transition"
                    >
                      <img
        ...
        {activeTab === "actions" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link to="/problems" className="block px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 text-center transition">
              View Problems
            </Link>
            <Link to="/editor/1" className="block px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 text-center transition">
              Open Editor
            </Link>
            <Link to="/submissions" className="block px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 text-center transition">
              View Submissions
            </Link>
            <Link to="/analytics" className="block px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 text-center transition">
              View Analytics
            </Link>
          </div>
        )}
